...
The `all` and `scaling` scenarios require Sink 0.22+ and enable chart-generated
...
runs require the chart's matching 0.22 release. Before release, pass a locally
